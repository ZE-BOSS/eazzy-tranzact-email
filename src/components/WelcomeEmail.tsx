      ...
      <Email preview="Welcome to Eazzy Tranzact">
        <Section>
            ...
            <Text className="text-[#1F2937] text-[24px] font-[600] leading-[21px]">
                Welcome to Eazzy Tranzact <span className="text-[24px] font-[600] leading-[21px]">🎉!</span>
            </Text>
        </Section>
        ...
        <Section className="relative">
            ...
            <Button 
                className="absolute bg-[#2874FC] text-white top-[0.5rem] cursor-pointer left-[15.31rem] px-[2.52rem] py-[0.55rem] rounded-md opacity-100 text-[16px] font-[600] leading-[20px] text-center"
                href={link}
            >
                Start Now
            </Button>
